...
<div class="grid h-full sm:place-items-center justify-center">
	<div class="mx-auto flex flex-col flex-col-reverse justify-end sm:flex-row">
		<div class=" m-6 -mt-1 sm:mt-20">
			<div class=" w-64 h-[200px] font-bold italic">
				<Typewriter mode="cascade" delay={0}>
					<p class="sm:mt-10">Are you prepared for onchain summer?</p>
				</Typewriter>
				<Typewriter delay={1500}>
					<p class="mt-3">sgmnt is in stealth mode, working hard to bring you the next big thing in fractional ownership.</p>
				</Typewriter>
               	<Typewriter delay={1500}>
					<p class="mt-3"></p>
				</Typewriter>
